...
export default function ReviewForm({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label className="block text-gray-700 mb-2" htmlFor="flashcardID">
          Flashcard ID:
        </label>
        <input
          id="flashcardID"
          ...
          required
          placeholder="Enter Card/Review ID here.."
          className="border border-gray-300 text-gray-600 rounded-md p-2 w-full"
          aria-describedby="flashcardIDHelp"
        />
        <small id="flashcardIDHelp" className="text-gray-500">
          This is the unique ID of the flashcard/Review you are reviewing.
        </small>
      </div>
